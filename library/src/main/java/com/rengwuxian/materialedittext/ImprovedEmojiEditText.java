...
public class ImprovedEmojiEditText extends EditText {
    ...
    public ImprovedEmojiEditText(Context context) {
        super(context);
        init(null /*attrs*/, 0 /*defStyleAttr*/, 0 /*defStyleRes*/);
    }
    
    public ImprovedEmojiEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, android.R.attr.editTextStyle, 0 /*defStyleRes*/);
    }
    
    public ImprovedEmojiEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0 /*defStyleRes*/);
    }
    
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ImprovedEmojiEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        if (!mInitialized) {
            ...
            setMaxEmojiCount(500); // EditTextAttributeHelper is not available, so this is just a fallback value
